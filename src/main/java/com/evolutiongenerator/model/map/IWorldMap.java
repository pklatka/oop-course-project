...
public interface IWorldMap {
    ...
    /**
     * @return List of conflicts that have arisen.
     */
    ...
    /**
     * Used to reduce the energy of animals after surviving the day.
     */
    void decreaseAnimalsEnergy();

    /**
     * Used to remove plants to consume.
     */
    void cleanPlantsToConsume();

    /**
     * Used to remove conflicts that have arisen.
     */
    void clearReproduceConflictedPositions();

    /**
     * Used to add dead animals.
     *
